# -*- coding: utf-8 -*-
"""hog_compare_efficientnet.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QPoSZ6MZ1EJzkoGGg1Z27grpfH8vN2lf
"""
...
def create_mlp(dim, regress=False):
	...
	model = Sequential()
	model.add(Dense(1024, input_dim=dim, activation="relu",kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01)))
...
def create_cnn(regress=False):
    ...
    base_out = base_vgg.output
    pool_out = tf.keras.layers.Flatten()(base_out)
    hidden1 = tf.keras.layers.Dense(512, activation='relu',kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01))(pool_out)
    drop1 = tf.keras.layers.Dropout(rate=0.3)(hidden1)
    hidden2 = tf.keras.layers.Dense(512, activation='relu',kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01))(drop1)
    drop2 = tf.keras.layers.Dropout(rate=0.3)(hidden2)

    if regress:
		    x = Dense(1, activation="linear")(x)
	  # construct the CNN
    model = Model(vgg, drop2)
	  # return the CNN
    return model
...
cnn = Model(base_vgg.input, drop2)
	  # return the CNN
...
x = Dense(1024, activation="relu",kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01))(combinedInput)
...
model.save('mymodel_malariamodhog_efficientnet.h5')
from google.colab import files
files.download('mymodel_malariamodhog_efficientnet.h5')



from tensorflow.keras.models import load_model
import efficientnet.keras as efn
model=load_model("/content/mymodel_malariamodhog_efficientnet.h5")
