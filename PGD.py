# -*- coding: utf-8 -*-
"""hog_compare_pgd.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Q1Ob_jO-begrymqUwLG9gAXDL5bkWizI
"""
...
for i in range(len(X_test_filtered)):
  ...
  #print(img)
  hog_norm=get_hog(img, name='hog_norm', save=True)
  print("normal image hog", hog_norm)
  hog_norm.reshape(1,2916)
  prediction = model([hog_norm,imgv])
  ...
  with tf.GradientTape() as tape:
    tape.watch(imgv)
    predictions = model([hog_norm,imgv])
